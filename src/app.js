...
app.get('/auth/callback',
  function(req, res) {
    ...
    const tokenURL = `https://vsapdev.tipler.com.br:8043/sap/bc/sec/oauth2/token?sap-client=100&grant_type=authorization_code&code=${code}&redirect_uri=https://bot.redware.io/auth/callback&client_id=ODATA_RED`;

    // Redirect the user's browser to the token endpoint
