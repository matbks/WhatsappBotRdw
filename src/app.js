...
client.on("message", async (message) => {
  if (message.body === 'Create Material') {
    // Here you can send a message to the user asking for the material details
    // After getting the details, you can call the SAP service
    // For example:
    // const materialDetails = await getMaterialDetailsFromUser(message);
    // callSapService(materialDetails);
  }
});
...
async function getMaterialDetailsFromUser(message) {
  // Send messages to the user asking for the material details
  // Wait for the user's responses
  // Return the material details
}

// This is a placeholder function. You'll need to implement the actual logic.
function callSapService(materialDetails) {
